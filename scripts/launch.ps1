...
# =============================================================================
#  launch.ps1 -- Media Downloader | Windows PowerShell launcher
#
#  Usage:
#    .\scripts\launch.ps1
#
...
#    4. Checks for yt-dlp updates and installs the latest if available
#    5. Launches Streamlit at http://localhost:8501 and opens in browser
#
...
if (-not (Test-Path (Join-Path $ProjectRoot "app.py"))) {
    Write-Error "[ERROR] app.py not found. Run launch.ps1 from inside the project folder."
    exit 1
}
...
function Write-Banner {
    ...
    Write-Host " |  Media Downloader  |  Setup & Launcher                   |" -ForegroundColor Cyan
    Write-Host " +----------------------------------------------------------+" -ForegroundColor Cyan
    Write-Host ""
}
...
# =============================================================================
Write-Host ""
Write-Info "[3.5/4] Checking for yt-dlp updates..."

python -m downloader.updater
if ($LASTEXITCODE -ne 0) {
    Write-Warn "yt-dlp update attempt returned an error."
    Write-Warn "The app will start with the currently installed version."
}
...
# =============================================================================
Write-Host ""
Write-Info "[4/4] Starting Media Downloader..."
